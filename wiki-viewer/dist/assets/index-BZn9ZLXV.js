 ...
 */var vd;function wg(){if(vd)return Cn;vd=1;var t=Symbol.for("react.element"),l=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),a=Symbol.for("react.strict_mode"),s=Symbol.for("react.profiler"),c=Symbol.for("react.provider"),u=Symbol.for("react.context"),f=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),g=Symbol.for("react.memo"),k=Symbol.for("react.lazy"),h=Symbol.iterator;function v(L){return L===null||typeof L!="object"?null:(L=h&&L[h]||L["@@iterator"],typeof L=="function"?L:null)}var A={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},E=Object.assign,R={};function F(L,N,C){this.props=L,this.context=N,this.refs=R,this.updater=C||A}F.prototype.isReactComponent={},F.prototype.setState=function(L,N){if(typeof L!="object"&&typeof L!="function"&&L!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,L,N,"setState")},F.prototype.forceUpdate=function(L){this.updater.enqueueForceUpdate(this,L,"forceUpdate")};function M(){}M.prototype=F.prototype;function U(L,N,C){this.props=L,this.context=N,this.refs=R,this.updater=C||A}var B=U.prototype=new M;B.constructor=U,E(B,F.prototype),B.isPureReactComponent=!0;var rn=Array.isArray,un=Object.prototype.hasOwnProperty,O={current:null},V={key:!0,ref:!0,__self:!0,__source:!0};function en(L,N,C){var gn,vn={},mn=null,Rn=null;if(N!=null)for(gn in N.ref!==void 0&&(Rn=N.ref),N.key!==void 0&&(mn=""+N.key),N)un.call(N,gn)&&!V.hasOwnProperty(gn)&&(vn[gn]=N[gn]);var Sn=arguments.length-2;if(Sn===1)vn.children=C;else if(1<Sn){for(var Tn=Array(Sn),Vn=0;Vn<Sn;Vn++)Tn[Vn]=arguments[Vn+2];vn.children=Tn}if(L&&L.defaultProps)for(gn in Sn=L.defaultProps,Sn)vn[gn]===void 0&&(vn[gn]=Sn[gn]);return{$$typeof:t,type:L,key:mn,ref:Rn,props:vn,_owner:O.current}}function cn(L,N){return{$$typeof:t,type:L.type,key:N,ref:L.ref,props:L.props,_owner:L._owner}}function D(L){return typeof L=="object"&&L!==null&&L.$$typeof===t}function Z(L){var N={"=":"=0",":":"=2"};return"$"+L.replace(/[=:]/g,function(C){return N[C]})}var Q=/\/+/g;function J(L,N){return typeof L=="object"&&L!==null&&L.key!=null?Z(""+L.key):N.toString(36)}function Y(L,N,C,gn,vn){var mn=typeof L;(mn==="undefined"||mn==="boolean")&&(L=null);var Rn=!1;if(L===null)Rn=!0;else switch(mn){case"string":case"number":Rn=!0;break;case"object":switch(L.$$typeof){case t:case l:Rn=!0}}if(Rn)return Rn=L,vn=vn(Rn),L=gn===""?"."+J(Rn,0):gn,rn(vn)?(C="",L!=null&&(C=L.replace(Q,"$&/")+"/"),Y(vn,N,C,"",function(Vn){return Vn})):vn!=null&&(D(vn)&&(vn=cn(vn,C+(!vn.key||Rn&&Rn.key===vn.key?"":(""+vn.key).replace(Q,"$&/")+"/")+L)),N.push(vn)),1;if(Rn=0,gn=gn===""?".":gn+":",rn(L))for(var Sn=0;Sn<L.length;Sn++){mn=L[Sn];var Tn=gn+J(mn,Sn);Rn+=Y(mn,N,C,Tn,vn)}else if(Tn=v(L),typeof Tn=="function")for(L=Tn.call(L),Sn=0;!(mn=L.next()).done;)mn=mn.value,Tn=gn+J(mn,Sn++),Rn+=Y(mn,N,C,Tn,vn);else if(mn==="object")throw N=String(L),Error("Objects are not valid as a React child (found: "+(N==="[object Object]"?"object with keys {"+Object.keys(L).join(", ")+"}":N)+"). If you meant to render a collection of children, use an array instead.");return Rn}function an(L,N,C){if(L==null)return L;var gn=[],vn=0;return Y(L,gn,"","",function(mn){return N.call(C,mn,vn++)}),gn}function xn(L){if(L._status===-1){var N=L._result;N=N(),N.then(function(C){(L._status===0||L._status===-1)&&(L._status=1,L._result=C)},function(C){(L._status===0||L._status===-1)&&(L._status=2,L._result=C)}),L._status===-1&&(L._status=0,L._result=N)}if(L._status===1)return L._result.default;throw L._result}var yn={current:null},$={transition:null},sn={ReactCurrentDispatcher:yn,ReactCurrentBatchConfig:$,ReactCurrentOwner:O};function S(){throw Error("act(...) is not supported in production builds of React.")}return Cn.Children={map:an,forEach:function(L,N,C){an(L,function(){N.apply(this,arguments)},C)},count:function(L){var N=0;return an(L,function(){N++}),N},toArray:function(L){return an(L,function(N){return N})||[]},only:function(L){if(!D(L))throw Error("React.Children.only expected to receive a single React element child.");return L}},Cn.Component=F,Cn.Fragment=i,Cn.Profiler=s,Cn.PureComponent=U,Cn.StrictMode=a,Cn.Suspense=m,Cn.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=sn,Cn.act=S,Cn.cloneElement=function(L,N,C){if(L==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+L+".");var gn=E({},L.props),vn=L.key,mn=L.ref,Rn=L._owner;if(N!=null){if(N.ref!==void 0&&(mn=N.ref,Rn=O.current),N.key!==void 0&&(vn=""+N.key),L.type&&L.type.defaultProps)var Sn=L.type.defaultProps;for(Tn in N)un.call(N,Tn)&&!V.hasOwnProperty(Tn)&&(gn[Tn]=N[Tn]===void 0&&Sn!==void 0?Sn[Tn]:N[Tn])}var Tn=arguments.length-2;if(Tn===1)gn.children=C;else if(1<Tn){Sn=Array(Tn);for(var Vn=0;Vn<Tn;Vn++)Sn[Vn]=arguments[Vn+2];gn.children=Sn}return{$$typeof:t,type:L.type,key:vn,ref:mn,props:gn,_owner:Rn}},Cn.createContext=function(L){return L={$$typeof:u,_currentValue:L,_currentValue2:L,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},L.Provider={$$typeof:c,_context:L},L.Consumer=L},Cn.createElement=en,Cn.createFactory=function(L){var N=en.bind(null,L);return N.type=L,N},Cn.createRef=function(){return{current:null}},Cn.forwardRef=function(L){return{$$typeof:f,render:L}},Cn.isValidElement=D,Cn.lazy=function(L){return{$$typeof:k,_payload:{_status:-1,_result:L},_init:xn}},Cn.memo=function(L,N){return{$$typeof:g,type:L,compare:N===void 0?null:N}},Cn.startTransition=function(L){var N=$.transition;$.transition={};try{L()}finally{$.transition=N}},Cn.unstable_act=S,Cn.useCallback=function(L,N){return yn.current.useCallback(L,N)},Cn.useContext=function(L){return yn.current.useContext(L)},Cn.useDebugValue=function(){},Cn.useDeferredValue=function(L){return yn.current.useDeferredValue(L)},Cn.useEffect=function(L,N){return yn.current.useEffect(L,N)},Cn.useId=function(){return yn.current.useId()},Cn.useImperativeHandle=function(L,N,C){return yn.current.useImperativeHandle(L,N,C)},Cn.useInsertionEffect=function(L,N){return yn.current.useInsertionEffect(L,N)},Cn.useLayoutEffect=function(L,N){return yn.current.useLayoutEffect(L,N)},Cn.useMemo=function(L,N){return yn.current.useMemo(L,N)},Cn.useReducer=function(L,N,C){return yn.current.useReducer(L,N,C)},Cn.useRef=function(L){return yn.current.useRef(L)},Cn.useState=function(L){return yn.current.useState(L)},Cn.useSyncExternalStore=function(L,N,C){return yn.current.useSyncExternalStore(L,N,C)},Cn.useTransition=function(){return yn.current.useTransition()},Cn.version="18.3.1",Cn}var Sd;function ks(){return Sd||(Sd=1,za.exports=wg()),za.exports}var Dn=ks();const Ba=ys(Dn);var Nl={},Ga={exports:{}},ye={},ja={exports:{}},Ha={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var wd;function Cg(){return wd||(wd=1,function(t){function l($,sn){var S=$.length;$.push(sn);n:for(;0<S;){var L=S-1>>>1,N=$[L];if(0<s(N,sn))$[L]=sn,$[S]=N,S=L;else break n}}function i($){return $.length===0?null:$[0]}function a($){if($.length===0)return null;var sn=$[0],S=$.pop();if(S!==sn){$[0]=S;n:for(var L=0,N=$.length,C=N>>>1;L<C;){var gn=2*(L+1)-1,vn=$[gn],mn=gn+1,Rn=$[mn];if(0>s(vn,S))mn<N&&0>s(Rn,vn)?($[L]=Rn,$[mn]=S,L=mn):($[L]=vn,$[gn]=S,L=gn);else if(mn<N&&0>s(Rn,S))$[L]=Rn,$[mn]=S,L=mn;else break n}}return sn}function s($,sn){var S=$.sortIndex-sn.sortIndex;return S!==0?S:$.id-sn.id}if(typeof performance=="object"&&typeof performance.now=="function"){var c=performance;t.unstable_now=function(){return c.now()}}else{var u=Date,f=u.now();t.unstable_now=function(){return u.now()-f}}var m=[],g=[],k=1,h=null,v=3,A=!1,E=!1,R=!1,F=typeof setTimeout=="function"?setTimeout:null,M=typeof clearTimeout=="function"?clearTimeout:null,U=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function B($){for(var sn=i(g);sn!==null;){if(sn.callback===null)a(g);else if(sn.startTime<=$)a(g),sn.sortIndex=sn.expirationTime,l(m,sn);else break;sn=i(g)}}function rn($){if(R=!1,B($),!E)if(i(m)!==null)E=!0,xn(un);else{var sn=i(g);sn!==null&&yn(rn,sn.startTime-$)}}function un($,sn){E=!1,R&&(R=!1,M(en),en=-1),A=!0;var S=v;try{for(B(sn),h=i(m);h!==null&&(!(h.expirationTime>sn)||$&&!Z());){var L=h.callback;if(typeof L=="function"){h.callback=null,v=h.priorityLevel;var N=L(h.expirationTime<=sn);sn=t.unstable_now(),typeof N=="function"?h.callback=N:h===i(m)&&a(m),B(sn)}else a(m);h=i(m)}if(h!==null)var C=!0;else{var gn=i(g);gn!==null&&yn(rn,gn.startTime-sn),C=!1}return C}finally{h=null,v=S,A=!1}}var O=!1,V=null,en=-1,cn=5,D=-1;function Z(){return!(t.unstable_now()-D<cn)}function Q(){if(V!==null){var $=t.unstable_now();D=$;var sn=!0;try{sn=V(!0,$)}finally{sn?J():(O=!1,V=null)}}else O=!1}var J;if(typeof U=="function")J=function(){U(Q)};else if(typeof MessageChannel<"u"){var Y=new MessageChannel,an=Y.port2;Y.port1.onmessage=Q,J=function(){an.postMessage(null)}}else J=function(){F(Q,0)};function xn($){V=$,O||(O=!0,J())}function yn($,sn){en=F(function(){$(t.unstable_now())},sn)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function($){$.callback=null},t.unstable_continueExecution=function(){E||A||(E=!0,xn(un))},t.unstable_forceFrameRate=function($){0>$||125<$?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):cn=0<$?Math.floor(1e3/$):5},t.unstable_getCurrentPriorityLevel=function(){return v},t.unstable_getFirstCallbackNode=function(){return i(m)},t.unstable_next=function($){switch(v){case 1:case 2:case 3:var sn=3;break;default:sn=v}var S=v;v=sn;try{return $()}finally{v=S}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function($,sn){switch($){case 1:case 2:case 3:case 4:case 5:break;default:$=3}var S=v;v=$;try{return sn()}finally{v=S}},t.unstable_scheduleCallback=function($,sn,S){var L=t.unstable_now();switch(typeof S=="object"&&S!==null?(S=S.delay,S=typeof S=="number"&&0<S?L+S:L):S=L,$){case 1:var N=-1;break;case 2:N=250;break;case 5:N=1073741823;break;case 4:N=1e4;break;default:N=5e3}return N=S+N,$={id:k++,callback:sn,priorityLevel:$,startTime:S,expirationTime:N,sortIndex:-1},S>L?($.sortIndex=S,l(g,$),i(m)===null&&$===i(g)&&(R?(M(en),en=-1):R=!0,yn(rn,S-L))):($.sortIndex=N,l(m,$),E||A||(E=!0,xn(un))),$},t.unstable_shouldYield=Z,t.unstable_wrapCallback=function($){var sn=v;return function(){var S=v;v=sn;try{return $.apply(this,arguments)}finally{v=S}}}}(Ha)),Ha}var Cd;function xg(){return Cd||(Cd=1,ja.exports=Cg()),ja.exports}/**
 * @license React
...
`);return{data:i,content:s}}function IS(t){Ul=t}function Ef(t){if(Ul.has(t))return Ul.get(t);for(const[l,i]of Ul)if(l.toLowerCase()===t.toLowerCase())return i;return null}function kp(t,l){const{data:i,content:a}=xS(t),s={type:i.type||"",tags:i.tags||[],created:i.created||"",updated:i.updated||"",title:i.title||Lf(a)};return{path:l,meta:s,content:a.trim(),raw:t}}function Lf(t){const l=t.match(/^#\s+(.+)$/m);return l?l[1].trim():""}function ES(t){var i;const l=new Map;for(const a of t){const s=a.content.match(/^#\s+(.+)$/m),c=s?s[1].trim():"";c&&l.set(c,a.path);const u=((i=a.path.split("/").pop())==null?void 0:i.replace(".md",""))||"";u&&!l.has(u)&&l.set(u,a.path),a.meta.title&&a.meta.title!==c&&l.set(a.meta.title,a.path)}return l}function LS(t){return t.replace(/\[\[([^\]|]+?)(?:\|(.+?))?\]\]/g,(l,i,a)=>{const s=i.trim(),c=Ef(s),u=(a==null?void 0:a.trim())||s;if(c){const f=c.replace(/.*\/wiki\//,"wiki/");return`[${u}](#wiki:${f})`}return`[${u} (待创建)](#wiki:${s})`})}function _S(t,l){if(!t||t.length<2)return[];const i=t.toLowerCase(),a=[];for(const s of l){if(s.path.includes("index.md")||s.path.includes("log.md"))continue;const c=s.meta.title||Lf(s.content),u=s.content.toLowerCase();let f=0;c.toLowerCase().includes(i)&&(f+=100),s.meta.tags.some(g=>g.toLowerCase().includes(i))&&(f+=50);const m=u.indexOf(i);if(m>=0&&(f+=10),f>0){let g="";if(m>=0){const k=Math.max(0,m-40),h=Math.min(s.content.length,m+i.length+60);g=(k>0?"...":"")+s.content.slice(k,h)+(h<s.content.length?"...":"")}else g=c;a.push({title:c,path:s.path,snippet:g,score:f})}}return a.sort((s,c)=>c.score-s.score).slice(0,10)}function RS({page:t,onNavigate:l,onTagSelect:i}){const a=Dn.useRef(null);Dn.useEffect(()=>{const u=a.current;if(!u)return;const f=m=>{const g=m.target.closest('a[href^="#wiki:"]');if(g){m.preventDefault();const h=g.getAttribute("href").replace("#wiki:","");console.log("[ContentViewer] wikilink clicked, target:",h),l(h)}};return u.addEventListener("click",f),()=>u.removeEventListener("click",f)},[l]);const s=Dn.useMemo(()=>t?LS(t.content):"",[t]);if(!t)return H.jsx("div",{className:"content-empty",children:H.jsxs("div",{style:{textAlign:"center"},children:[H.jsx("svg",{width:"64",height:"64",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:H.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"})}),H.jsx("p",{style:{fontSize:13},children:"从左侧选择页面开始阅读"})]})});const{meta:c}=t;return H.jsx("div",{ref:a,className:"content",children:H.jsxs("div",{className:"content-inner",children:[H.jsxs("div",{className:"meta-row",children:[c.type&&H.jsx("span",{className:`meta-type ${c.type}`,children:c.type}),c.created&&H.jsxs("span",{className:"meta-date",children:["创建: ",c.created]}),c.updated&&c.updated!==c.created&&H.jsxs("span",{className:"meta-date",children:["更新: ",c.updated]})]}),c.tags.length>0&&H.jsx("div",{className:"tags-row",children:c.tags.map(u=>H.jsxs("button",{className:"tag tag-clickable",onClick:()=>i(u),title:"按此标签筛选",children:["#",u]},u))}),H.jsx("div",{className:"md-content",children:H.jsx(u1,{remarkPlugins:[CS],children:s})})]})})}function PS({open:t,onClose:l,onSearch:i,onSelect:a}){const[s,c]=Dn.useState(""),[u,f]=Dn.useState([]),[m,g]=Dn.useState(0),k=Dn.useRef(null);Dn.useEffect(()=>{t&&(c(""),f([]),g(0),setTimeout(()=>{var v;return(v=k.current)==null?void 0:v.focus()},100))},[t]),Dn.useEffect(()=>{if(!t)return;const v=A=>{A.key==="Escape"&&l(),A.key==="ArrowDown"&&(A.preventDefault(),g(E=>Math.min(E+1,u.length-1))),A.key==="ArrowUp"&&(A.preventDefault(),g(E=>Math.max(E-1,0))),A.key==="Enter"&&u[m]&&(a(u[m].path),l())};return window.addEventListener("keydown",v),()=>window.removeEventListener("keydown",v)},[t,u,m,l,a]);const h=v=>{c(v),g(0),f(v.length>=2?i(v):[])};return t?H.jsx("div",{className:"modal-overlay",onClick:v=>{v.target===v.currentTarget&&l()},children:H.jsxs("div",{className:"modal",children:[H.jsxs("div",{className:"modal-input",children:[H.jsx("svg",{width:"20",height:"20",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",style:{color:"var(--text-muted)",flexShrink:0},children:H.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"})}),H.jsx("input",{ref:k,type:"text",value:s,onChange:v=>h(v.target.value),placeholder:"搜索页面、概念、实体..."}),H.jsx("kbd",{style:{fontSize:10,padding:"2px 6px",borderRadius:4,background:"var(--surface)",color:"var(--text-muted)"},children:"ESC"})]}),H.jsxs("div",{className:"modal-results",children:[u.length===0&&s.length>=2&&H.jsx("div",{className:"modal-empty",children:"未找到匹配结果"}),u.length===0&&s.length<2&&H.jsx("div",{className:"modal-empty",children:"输入至少 2 个字符搜索"}),u.map((v,A)=>H.jsxs("button",{onClick:()=>{a(v.path),l()},className:"modal-result"+(A===m?" sel":""),children:[H.jsx("div",{className:"rtitle",children:v.title}),H.jsx("div",{className:"rsnippet",children:v.snippet})]},v.path))]})]})}):null}const Ap=Object.assign({"../../wiki/concepts/agent-memory-system.md":Pg,"../../wiki/concepts/agent-tool-selection.md":Dg,"../../wiki/concepts/ai-agent.md":Tg,"../../wiki/concepts/ai-gateway.md":Mg,"../../wiki/concepts/ai-programming.md":Og,"../../wiki/concepts/context-engineering.md":bg,"../../wiki/concepts/dev-flow-unified-paradigm.md":Fg,"../../wiki/concepts/fde.md":Ng,"../../wiki/concepts/loop-engineering.md":zg,"../../wiki/concepts/mcp-model-context-protocol.md":Bg,"../../wiki/concepts/model-finetuning.md":Gg,"../../wiki/concepts/model-fusion.md":jg,"../../wiki/concepts/moe-mixture-of-experts.md":Hg,"../../wiki/concepts/okf-open-knowledge-format.md":Ug,"../../wiki/concepts/ontology.md":Wg,"../../wiki/concepts/prompt-caching.md":Vg,"../../wiki/concepts/rag-retrieval-augmented-generation.md":qg,"../../wiki/concepts/red-green-regression-testing.md":Qg,"../../wiki/concepts/self-improving-agent.md":$g,"../../wiki/concepts/spec-driven-development.md":Jg,"../../wiki/concepts/test-driven-development.md":Kg,"../../wiki/entities/apache-burr.md":Yg,"../../wiki/entities/autolink.md":Xg,"../../wiki/entities/bmad.md":Zg,"../../wiki/entities/cc-connect.md":nh,"../../wiki/entities/cc-switch.md":eh,"../../wiki/entities/claude-code.md":th,"../../wiki/entities/codex-cli.md":rh,"../../wiki/entities/comet.md":ih,"../../wiki/entities/ecc.md":lh,"../../wiki/entities/firecrawl.md":oh,"../../wiki/entities/flashrt.md":ah,"../../wiki/entities/fuseai.md":sh,"../../wiki/entities/gsd.md":uh,"../../wiki/entities/gstack.md":ch,"../../wiki/entities/hermes-agent.md":dh,"../../wiki/entities/html-video.md":ph,"../../wiki/entities/huashu-design.md":fh,"../../wiki/entities/infifusion.md":mh,"../../wiki/entities/khazix-skills.md":gh,"../../wiki/entities/lightrag.md":hh,"../../wiki/entities/mempalace.md":yh,"../../wiki/entities/mergekit.md":kh,"../../wiki/entities/mux0.md":Ah,"../../wiki/entities/openclaw.md":vh,"../../wiki/entities/openspec.md":Sh,"../../wiki/entities/opensquilla.md":wh,"../../wiki/entities/pageagent.md":Ch,"../../wiki/entities/pythia.md":xh,"../../wiki/entities/rag-anything.md":Ih,"../../wiki/entities/seeder.md":Eh,"../../wiki/entities/snail-ai.md":Lh,"../../wiki/entities/spec-kit.md":_h,"../../wiki/entities/superpowers.md":Rh,"../../wiki/entities/understand-anything.md":Ph,"../../wiki/entities/unsloth.md":Dh,"../../wiki/entities/uzi-skill.md":Th,"../../wiki/index.md":Mh,"../../wiki/log.md":Oh,"../../wiki/synthesis/2026-h1-wanxiang-review.md":bh,"../../wiki/synthesis/agent-framework-comparison.md":Fh,"../../wiki/synthesis/ai-dev-trifecta.md":Nh,"../../wiki/synthesis/bmad-vs-openspec.md":zh,"../../wiki/synthesis/model-fusion-deep-report.md":Bh,"../../wiki/tags-index.md":Gh,"../../wiki/topics/agentic-rag.md":jh,"../../wiki/topics/ai-agent-landscape-2026.md":Hh,"../../wiki/topics/ai-native-dev-system.md":Uh,"../../wiki/topics/firecrawl-web-scraping.md":Wh,"../../wiki/topics/karpathy-ai-coding-methodology.md":Vh,"../../wiki/topics/llm-wiki-methodology.md":qh,"../../wiki/topics/opensquilla-ai-self-verification.md":Qh,"../../wiki/topics/rag-evaluation.md":$h,"../../wiki/topics/snail-ai-agent-platform.md":Jh,"../../wiki/topics/starrocks-cross-data-source-query.md":Kh,"../../wiki/topics/unsloth-efficient-llm-finetuning.md":Yh,"../../wiki/topics/wanxiang-ai-analysis.md":Xh}),DS={entities:"实体",concepts:"概念",papers:"论文",topics:"主题",synthesis:"综述"};function TS(t,l){var k,h;const i=t.split(`
...
`).match(/^#\s+(.+)/m),f=u?u[1].trim():a.title||((h=l.split("/").pop())==null?void 0:h.replace(".md",""))||"Untitled";l.split("/").slice(-2,-1)[0];let m=[];a.tags&&(Array.isArray(a.tags)?m=a.tags:typeof a.tags=="string"&&(m=a.tags.split(",").map(v=>v.trim())));const g=l.replace(/.*\/wiki\//,"wiki/");return{title:f,path:g,summary:a.summary||"",tags:m}}function vp(){return window.location.hash.slice(1)||null}function MS(){const[t,l]=Dn.useState(()=>vp()),[i,a]=Dn.useState(new Set(["实体","概念","论文","综述"])),[s,c]=Dn.useState(!1),[u,f]=Dn.useState(!1),[m,g]=Dn.useState(null);Dn.useEffect(()=>{t?window.location.hash="#"+t:history.replaceState(null,"",window.location.pathname+window.location.search)},[t]),Dn.useEffect(()=>{const V=()=>l(vp());return window.addEventListener("hashchange",V),()=>window.removeEventListener("hashchange",V)},[]);const{allPages:k,categories:h,allTags:v}=Dn.useMemo(()=>{const V=[],en=new Map,cn=new Map;for(const[Q,J]of Object.entries(Ap)){if(Q.includes("/index.md")||Q.includes("/log.md"))continue;try{const yn=Q.replace(/.*\/wiki\//,"wiki/"),$=kp(J,yn);V.push($)}catch(yn){console.error("[App] Failed to parse:",Q,yn)}const Y=TS(J,Q),an=Q.split("/").slice(-2,-1)[0]||"",xn=DS[an]||an;for(const yn of Y.tags)cn.set(yn,(cn.get(yn)||0)+1);en.has(xn)||en.set(xn,[]),en.get(xn).push(Y)}const D=[];for(const Q of["实体","概念","论文","主题","综述"]){const J=en.get(Q);J&&J.length>0&&(D.push({name:Q,pages:J,collapsed:i.has(Q)}),en.delete(Q))}for(const[Q,J]of en)D.push({name:Q,pages:J,collapsed:i.has(Q)});const Z=Array.from(cn.entries()).map(([Q,J])=>({name:Q,count:J})).sort((Q,J)=>J.count-Q.count||Q.name.localeCompare(J.name));return{allPages:V,categories:D,allTags:Z}},[i]);Dn.useEffect(()=>{IS(ES(k))},[k]);const A=Dn.useMemo(()=>{if(!t)return null;const V="../../"+t,en=Ap[V];return en?kp(en,V):null},[t]),E=Dn.useCallback(V=>{l(V.path),g(null),f(!1)},[]),R=Dn.useCallback(V=>{const en=Ef(V);l(en||V)},[]),F=Dn.useCallback(V=>{a(en=>{const cn=new Set(en);return cn.has(V)?cn.delete(V):cn.add(V),cn})},[]),M=Dn.useCallback(V=>_S(V,k),[k]),U=Dn.useCallback(V=>{l(V),g(null)},[]),B=Dn.useCallback(V=>{g(m===V?null:V)},[m]);Dn.useEffect(()=>{const V=en=>{en.key==="k"&&(en.metaKey||en.ctrlKey)&&(en.preventDefault(),c(cn=>!cn))};return window.addEventListener("keydown",V),()=>window.removeEventListener("keydown",V)},[]);const rn=Dn.useMemo(()=>m?h.map(V=>({...V,pages:V.pages.filter(en=>en.tags.includes(m))})).filter(V=>V.pages.length>0):h,[h,m]),un=k.length,O=m?rn.reduce((V,en)=>V+en.pages.length,0):un;return H.jsxs("div",{className:"app",children:[H.jsxs("div",{className:"mobile-header",children:[H.jsx("button",{onClick:()=>f(!u),style:{padding:6,borderRadius:8},children:H.jsx("svg",{width:"20",height:"20",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:H.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M4 6h16M4 12h16M4 18h16"})})}),H.jsx("h1",{style:{fontSize:14,fontWeight:600,color:"var(--accent)"},children:"LLM Wiki"}),H.jsx("button",{onClick:()=>c(!0),style:{marginLeft:"auto",padding:6,borderRadius:8},children:H.jsx("svg",{width:"20",height:"20",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:H.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"})})})]}),H.jsxs("div",{className:"main-area",children:[H.jsx("div",{className:"sidebar-desktop",style:{height:"100%"},children:H.jsx(Rd,{categories:rn,activePath:t,onSelect:E,onToggleCategory:F,onSearch:()=>c(!0),pageCount:O,allTags:v,activeTag:m,onTagSelect:B})}),u&&H.jsxs("div",{className:"mobile-overlay",children:[H.jsx("div",{className:"mobile-overlay-bg",onClick:()=>f(!1)}),H.jsx("div",{className:"mobile-overlay-sidebar",children:H.jsx(Rd,{categories:rn,activePath:t,onSelect:E,onToggleCategory:F,onSearch:()=>{f(!1),c(!0)},pageCount:O,allTags:v,activeTag:m,onTagSelect:B})})]}),H.jsx(RS,{page:A,onNavigate:R,onTagSelect:B})]}),H.jsxs("div",{className:"status-bar",children:[H.jsxs("span",{children:[O," 个页面"]}),m&&H.jsxs(H.Fragment,{children:[H.jsx("span",{children:"·"}),H.jsxs("span",{style:{color:"var(--accent)"},children:["标签: #",m]})]}),A&&!m&&H.jsxs(H.Fragment,{children:[H.jsx("span",{style:{color:"var(--border)"},children:"|"}),H.jsx("span",{children:A.path})]})]}),H.jsx(PS,{open:s,onClose:()=>c(!1),onSearch:M,onSelect:U})]})}Rg.createRoot(document.getElementById("root")).render(Ba.createElement(Ba.StrictMode,null,Ba.createElement(MS)));
